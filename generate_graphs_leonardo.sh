...
BASE_CONFIG=/leonardo_work/DestE_340_26/users/sbuurman/auto-graphs/config/hectometric_finetuning_leonardo.yaml # Base config to copy from, should have placeholders null for dataset paths
...
echo $ITEM
echo $FULL_DATA_PATH
sed -e "s|hectometric_dataset_training: null|hectometric_dataset_training: ${FULL_DATA_PATH}|" \
...
# -e 's|drop: \[cp, q_250, q_50, q_600, sdor, slor, stl1, swvl1, t_250, t_50, t_600, tcw, u_250, u_50, u_600, v_250, v_50, v_600, w_250, w_50, w_600, z_250, z_50, z_600\]|drop: [cp, q_250, q_50, q_600, sdor, slor, stl1, swvl1, t_250, t_50, t_600, tcw, u_250, u_50, u_600, v_250, v_50, v_600, w_250, w_50, w_600, z_250, z_50, z_600, 100u, 100v]|' \
